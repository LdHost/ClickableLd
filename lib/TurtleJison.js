...
case 14:
        ...
        this.$ = [{ "type": "n3Prefix", keyword: $$[$0-6], ws1: $$[$0-5], prefix: $$[$0-4], ws2: $$[$0-3], namespace: $$[$0-2], ws3: $$[$0-1], dot: $$[$0] }];
      
break;
case 15:

        yy._setBase($$[$0-2].value);
        this.$ = [{ "type": "n3Base", keyword: $$[$0-4], ws1: $$[$0-3], base: $$[$0-2], ws2: $$[$0-1], dot: $$[$0] }];
...
break;
case 76:
 this.$ = yy.createPrefixedIri($$[$0].origText); 
break;
        }
    }
}
